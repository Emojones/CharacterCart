...
namespace CharacterCart.DAL.EfStructures.Migrations
{
    ...
    [Migration("20180419001153_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CharacterCart.Models.Entities.Character", b =>
                {
                    ...
                    b.Property<int?>("CharacterRaceIdId");
                    ...
                    b.Property<int?>("WeaponIdId");

                    b.HasKey("Id");

                    b.HasIndex("CharacterRaceIdId");

                    b.HasIndex("ClassIdId");

                    b.HasIndex("PlayerIdId");

                    b.HasIndex("WeaponIdId");
            ...
            modelBuilder.Entity("CharacterCart.Models.Entities.Character", b =>
                {
                    b.HasOne("CharacterCart.Models.Entities.CharacterRaces", "CharacterRaceId")
                        .WithMany()
                        .HasForeignKey("CharacterRaceIdId");

                    b.HasOne("CharacterCart.Models.Entities.Classes", "ClassId")
                        .WithMany()
                        .HasForeignKey("ClassIdId");

                    b.HasOne("CharacterCart.Models.Entities.Player", "PlayerId")
                        .WithMany()
                        .HasForeignKey("PlayerIdId");

                    b.HasOne("CharacterCart.Models.Entities.Weapons", "WeaponId")
                        .WithMany()
                        .HasForeignKey("WeaponIdId");
                });
